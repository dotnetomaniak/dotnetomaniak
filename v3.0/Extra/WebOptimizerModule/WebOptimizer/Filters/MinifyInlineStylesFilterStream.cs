...
namespace WebOptimizer.Filters
{
	...
	/// </summary>
	public class MinifyInlineStylesFilterStream : BaseFilterStream
	{
		...
		public MinifyInlineStylesFilterStream(HttpContext context)
		{
		...
		protected override void Process(byte[] buffer, int offset, int count)
		{
			...
			foreach (Match match in matches)
			{
				...
				html = html.Replace(style, Processor.RemoveWhiteSpaceFromStylesheets(style));
			}
