var Administration =
{
    ...
    publish : function()
    {
            ...
            $.ajax(
                        {
                            ...
                            beforeSend: function()
                            {
                                $U.showProgress('Publikowanie artykułów...');
                            },
                            success: function(result)
                            {
                                $U.hideProgress();
                                ...
                                if (result.isSuccessful)
                                {
                                    $U.messageBox('Sukces', 'Udało się opublikować artykuły.', false);
                                }
                                else
                                {
                                    $U.messageBox('Bład', result.errorMessage, true);
                                }
                            }
                        }
                    );
        ...
        $U.confirm('Opublikować?', 'Jesteś pewien, że chcesz opublikować artykuły?', doPublish);
    },
