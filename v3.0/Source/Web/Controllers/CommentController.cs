    ...
    public class CommentController : BaseController
    {
        ...
        public ActionResult Post(string id, string body, bool? subscribe)
        {
            ...
            JsonViewData viewData = Validate<JsonViewData>(
                                                            ...
                                                            new Validation(() => string.IsNullOrEmpty(body.NullSafe()), "Komentarz nie mo¿e byæ pusty."),
                                                            ...
                                                            new Validation(() => captchaEnabled && !CaptchaValidator.Validate(CurrentUserIPAddress, captchaChallenge, captchaResponse), "Weryfikacja Captcha nie powiod³a siê")
                                                          );
