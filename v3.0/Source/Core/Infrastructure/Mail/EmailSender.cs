namespace Kigg.Infrastructure
{
    ...
    public class EmailSender : IEmailSender
    {
        ...
        public void NotifySpamStory(string url, IStory story, string source)
        {
            ...
            SendMailAsync(_settings.WebmasterEmail, _settings.SupportEmail, "Opublikowano spam artykuł - {0}".FormatWith(SystemTime.Now().ToLongDateString()), body);
        }
        ...
        public void NotifyStoryMarkedAsSpam(string url, IStory story, IUser byUser)
        {
            ...
            SendMailAsync(_settings.WebmasterEmail, _settings.SupportEmail, "Artykuł oznaczony jako spam - {0}".FormatWith(SystemTime.Now().ToLongDateString()), body);
        }
        ...
        public void NotifyStoryApprove(string url, IStory story, IUser byUser)
        {
            ...
            SendMailAsync(_settings.WebmasterEmail, _settings.SupportEmail, "Artykuł zatwierdzony - {0}".FormatWith(SystemTime.Now().ToLongDateString()), body);
        }
        ...
        public void NotifyConfirmSpamStory(string url, IStory story, IUser byUser)
        {
            ...
            SendMailAsync(_settings.WebmasterEmail, _settings.SupportEmail, "Artykuł zaznaczony jako spam - {0}".FormatWith(SystemTime.Now().ToLongDateString()), body);
        }
