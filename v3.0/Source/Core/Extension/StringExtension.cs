...
using System.Collections.Generic;
    ...
    public static class StringExtension
    {
        ...
        private static readonly Dictionary<char, char> PolishNationalChars = new Dictionary<char, char>()
                                                                                 {
                                                                                     {'ą', 'a'},
                                                                                     {'ć', 'c'},
                                                                                     {'ę', 'e'},
        ...
        [DebuggerStepThrough]
        public static string RemovePolishNationalChars(this string target)
        {
            if (string.IsNullOrEmpty(target))
                return target;

            return PolishNationalChars.Keys.Aggregate(target, (current, c) => current.Replace(c.ToString(Constants.CurrentCulture), PolishNationalChars[c].ToString()));
        }
